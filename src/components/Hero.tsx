    ...
    <section className="relative min-h-[100svh] pt-32 pb-24 px-6 md:px-12 flex flex-col justify-center overflow-hidden bg-transparent">
      ...
      >
        <div className="flex flex-wrap">
          {words.map((word, index) => (
            <motion.span 
              key={index}
              variants={child}
              className="font-display font-bold text-[clamp(1.8rem,10vw,4rem)] md:text-6xl lg:text-8xl xl:text-[7rem] leading-[0.85] md:leading-none mr-[2vw] md:mr-[1.5vw] mb-1 md:mb-6 uppercase tracking-tighter"
            >
        ...
        <motion.div 
          ...
          className="mt-4 md:mt-8 font-sans font-light text-lg md:text-3xl text-white/90 tracking-wide leading-relaxed"
        >
